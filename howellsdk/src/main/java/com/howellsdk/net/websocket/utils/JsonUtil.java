package com.howellsdk.net.websocket.utils;
...
public class JsonUtil {
    ...
    public static JSONObject createAlarmAliveJsonObject(int cseq, long systemUpTime, @Nullable Double longitude,@Nullable Double latitude) throws JSONException {
        JSONObject obj = new JSONObject();
        ...
        if (longitude!=null) keepAlive.put("Longitude",longitude);
        if (latitude!=null)   keepAlive.put("Latitude",latitude);
